...
### DO I NEED TO INCLUDE DUMMIES? HOW?
...
coeftest(q3_ols1, vcov = vcovHC(q3_ols1, type = "HC1")) #%>%
  tidy() %>%
...
## Table
```{r}
model_list <- c(q3_ols1, q3_ols2, q3_ols3)

stargazer(q3_ols1, q3_ols2, type = "latex", 
          title = "5f(iii).C", keep = c("treat1_after", "treat2_after", "treat3_after"),digits = 4)
```

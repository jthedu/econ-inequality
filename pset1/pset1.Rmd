...
iv_ssi_c <- ivreg(diff_dSSI ~ 
                    diff_earnPOW + as.factor(year)*as.factor(state) + msa + lnpop + diff_pop + frac_earn | valchange_cr + valchange_crlag1 + valchange_crlag2 + as.factor(year)*as.factor(state) + msa + lnpop + diff_pop + frac_earn, data = q1)
